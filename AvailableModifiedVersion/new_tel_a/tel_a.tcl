# 
# Project automation script for tel_a 
# 
# Created for ISE version 14.3
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source tel_a.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../common/ipcore_dir/ram_32x16_single_modified.vhd"
D
D 
D
   xfile add "../common/ipcore_dic
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/haein/Downloads/fazia/tel_a/xst" -process "Synthesize - XST"
